    ...
    return (
        <footer className="bg-bg-secondary border-t border-border-primary mt-auto">
            <Container className="py-12">
                {/* Top Section */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 pb-8 border-b border-border-primary">
                    {/* Brand Section */}
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-sm text-text-tertiary mb-4 max-w-xs">
                            Professional web application vulnerability scanner powered by advanced AI technology.
                        ...
                        <div className="flex items-center gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 flex items-center justify-center rounded-lg bg-bg-hover text-text-tertiary hover:text-accent-green hover:bg-accent-green/10 transition-all duration-200"
                            ...
                            <ul className="space-y-2">
                                {section.links.map((link) => (
                                    <li key={link.name}>
                                        <Link
                                            to={link.path}
                                            className="text-sm text-text-tertiary hover:text-accent-green transition-colors duration-200"
                                        >
                                            {link.name}
                                        </Link>
                                    </li>
                ...
                <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-sm text-text-tertiary">
                        © {currentYear} SafeWeb AI. All rights reserved.
                    </p>
